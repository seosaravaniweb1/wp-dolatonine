...
function dolat_render_estelam_metabox( $post ) {
	...
	<p class="dolat-mb-hint">از باکس «دسته‌ها» در ستون کناری، زیردسته <strong>«استعلام …»</strong> بخش موردنظر را انتخاب کنید (مثلا «استعلام یارانه‌ها») — همان چیزی که لیستینگ این بخش را می‌سازد. برچسب کوچک روی کارت (خودرو، مالی، ملک، بیمه و...) از باکس <strong>«برچسب‌ها»</strong>ی معمولی وردپرس خوانده می‌شود و رنگ کارت را تعیین می‌کند.</p>
	<?php
}
